...
public class AudioProcessor : MonoBehaviour
{
	...
	void Start ()
	{
        gThresh = 1 - ((float)GameManager.difficulty / 100);
    ...
    {
        string songName = GameManager.song;

        audioSource.Stop();
        AudioSource foundAudio = GameObject.Find(songName).GetComponent<AudioSource>();
        audioSource.clip = foundAudio.clip;
        audioSource.Play();
